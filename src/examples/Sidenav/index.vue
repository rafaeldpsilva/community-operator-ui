<template>
  ...
  <aside class="my-3 overflow-auto border-0 sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl" :class="`${'fixed-start ms-3'} 
    ...
    <div class="sidenav-header">
      ...
      <router-link class="m-0 navbar-brand" to="/">
        ...
        <span class="ms-2 font-weight-bold me-2">Community Operator</span>
      </router-link>
    </div>
