  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        ...
        <div class="mt-4" @click="toggle" :class="'float-end'">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div class="my-2 badge-colors" :class="' text-start'">
        ...
        <div class="d-flex gap-2">
          <button id="btn-white" class="btn w-100 px-3 mb-2" :class="this.$store.state.sidebarType === 'bg-white'
              ? 'bg-gradient-success'
              : 'btn-outline-success'
            " @click="sidebarType('bg-white')">
            White
          </button>
          <button id="btn-dark" class="btn w-100 px-3 mb-2" :class="this.$store.state.sidebarType === 'bg-default'
              ? 'bg-gradient-success'
              : 'btn-outline-success'
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="mt-1 form-check-input" :class="' ms-auto'
        ...
        <a class="btn btn-outline-dark w-100"
          href="https://www.creative-tim.com/learning-lab/vue/overview/argon-dashboard/">View documentation</a>
        <div class="text-center w-100">
          <a class="github-button" href="https://github.com/creativetimofficial/vue-argon-dashboard"
