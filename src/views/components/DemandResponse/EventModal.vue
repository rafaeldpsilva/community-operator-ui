        ...
        <div v-if="show" class="modal-mask" @keydown.esc="close()">
            <div class="modal-container">
                ...
                <div class="modal-body py-4">
                    <div class="row">
                        <div class="col-8">
                            <event-monitoring-modal :event_time="event_time"/>
                        </div>
                        <div class="col-4">
                            <invitations-table :event_time="event_time"/>
                        </div>
                    </div>
                    <div class="row py-4">
                        <div class="col-12">
                            <modal-ranking-table :event_time="event_time"/>
                        </div>
                    </div>
                </div>
            </div>
...
import ModalRankingTable from './ModalRankingTable.vue';
